...
export interface ApiItemItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Large_Description: Attribute.Text &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        maxLength: 1000;
      }>;
...
export interface ApiSlideShowSlideShow extends Schema.CollectionType {
  collectionName: 'slide_shows';
  info: {
    singularName: 'slide-show';
    pluralName: 'slide-shows';
    displayName: 'SlideShows';
  };
  options: {
    draftAndPublish: true;
  };
